...
\begin{figure*}[hbt]
	...
	\subfigure[RMAT parameters a=40\%, b=30\%, c=20\%, and d=10\%]{\includegraphics[page=1,width=.32\linewidth]{figures/rmat/cascade_label_propagation_perfomance_gain_against_edge_factor.pdf} \label{fig:rmat_lp_ef_2}}
	\subfigure[RMAT parameters a=57\%, b=19\%, c=19\%, and d=5\%]{\includegraphics[page=1,width=.32\linewidth]{figures/rmat/cascade_label_propagation_perfomance_gain_against_edge_factor.pdf} \label{fig:rmat_lp_ef_3}}
...
\begin{figure*}[hbt]
	...
	\subfigure[RMAT parameters a=40\%, b=30\%, c=20\%, and d=10\%]{\includegraphics[page=1,width=.32\linewidth]{figures/rmat/cascade_label_propagation_perfomance_gain_against_vertices.pdf}\label{fig:rmat_lp_nodes_2}}
	\subfigure[RMAT parameters a=57\%, b=19\%, c=19\%, and d=5\%]{\includegraphics[page=1,width=.32\linewidth]{figures/rmat/cascade_label_propagation_perfomance_gain_against_vertices.pdf}\label{fig:rmat_lp_nodes_3}}
...
\begin{figure*}[hbt]
 	\centering
  	...
  	\subfigure[RMAT parameters a=40\%, b=30\%, c=20\%, and d=10\%]{\includegraphics[page=1,width=.32\linewidth]{figures/rmat/cascade_onpl_perfomance_gain_against_edge_factor.pdf}\label{fig:rmat_lv_ef_2}}
  	\subfigure[RMAT parameters a=57\%, b=19\%, c=19\%, and d=5\%]{\includegraphics[page=1,width=.32\linewidth]{figures/rmat/cascade_onpl_perfomance_gain_against_edge_factor.pdf}\label{fig:rmat_lv_ef_3}}
...
\begin{figure*}[hbt]
	...
	\subfigure[RMAT parameters a=40\%, b=30\%, c=20\%, and d=10\%]{\includegraphics[page=1,width=.32\linewidth]{figures/rmat/cascade_onpl_perfomance_gain_against_vertices.pdf}\label{fig:rmat_lv_nodes_2}}
	\subfigure[RMAT parameters a=57\%, b=19\%, c=19\%, and d=5\%]{\includegraphics[page=1,width=.32\linewidth]{figures/rmat/cascade_onpl_perfomance_gain_against_vertices.pdf}\label{fig:rmat_lv_nodes_3}}

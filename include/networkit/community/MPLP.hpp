...
#ifndef NETWORKIT_COMMUNITY_MPLP_HPP_
#define NETWORKIT_COMMUNITY_MPLP_HPP_
 ...
 *
 */
class MPLP final : public CommunityDetectionAlgorithm {
...
public:
     ...
     */
    MPLP(const Graph& G, count theta = none, count maxIterations=none);
     ...
     * @param[in] theta updateThreshold: number of nodes that have to be changed in each iteration so that a new iteration starts.
     */
    MPLP(const Graph &G, const Partition &baseClustering, count theta = none);
...
#endif // NETWORKIT_COMMUNITY_MPLP_HPP_
